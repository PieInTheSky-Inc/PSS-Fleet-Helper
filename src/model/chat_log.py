...
class PssChatLogger(_orm.ModelBase):
    ...
    last_pss_message_id = _db.Column(
        "last_pss_message_id", _db.Integer, nullable=False, default=0
    )
    ...
    @classmethod
    def make(
        cls, guild_id: int, log_to_channel_id: int, pss_channel_key: str, name: str
    ) -> "PssChatLogger":
